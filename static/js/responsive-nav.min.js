!function(a, b, c) {
    ...
    var d = function(d, e) {
        ...
        var g, h, i, j, k, l, m = function(a, b, c, d) {
        ...
        }, s = a.createElement("style"), t = a.documentElement, u = function(b, c) {
            var d;
            this.options = {
                animate: !0,
                transition: 284,
            ...
            for (d in c)
                this.options[d] = c[d];
            if (q(t, this.options.jsClass), this.wrapperEl = b.replace("#", ""), a.getElementById(this.wrapperEl))
        ...
        return u.prototype = {
            ...
            open: function() {
                l || (r(g, "closed"), q(g, "opened"), q(t, h.navActiveClass), q(i, "active"), g.style.position = h.openPos, p(g, {
                    "aria-hidden": "false"
                }), l=!0, h.open())
            },
            close: function() {
                l && (q(g, "closed"), r(g, "opened"), r(t, h.navActiveClass), r(i, "active"), p(g, {
                    "aria-hidden": "true"
            ...
            _createStyles: function() {
                s.parentNode || (s.type = "text/css", a.getElementsByTagName("head")[0].appendChild(s))
            },
            ...
            _closeOnNavClick: function() {
                if (h.closeOnNavClick && "querySelectorAll"in a && Array.prototype.forEach) {
                    var b = g.querySelectorAll("a"), c = this;
                    [].forEach.call(b, function(a, d) {
                        m(b[d], "click", function() {
                            k && c.toggle()
                        }, !1)
                    })
                }
            ...
            _calcHeight: function() {
                ...
                s.styleSheet ? s.styleSheet.cssText = c : s.innerHTML = c, c = ""
            }
        }, new u(d, e)
    };
    b.responsiveNav = d
